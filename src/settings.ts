...
const ICONS = {
	...
	syncInfinity: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: text-bottom; margin-right: 8px;"><rect x="3" y="3" width="13" height="13" rx="2.5"/><path d="M7 8h5"/><path d="M7 11h3"/><path d="M17 9v8a2.5 2.5 0 0 1-2.5 2.5H7"/><polyline points="14 17 17 20 20 17"/></svg>`,
